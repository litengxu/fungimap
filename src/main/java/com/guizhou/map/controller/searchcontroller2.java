...
//        System.out.println("coiumn:"+column);
...
//            }else{//分块图
//               // modelAndView.addObject("list",list.toString());
//                double [][]arr2 = predictService.listconverttoarr_p(list2,list);
//                //初始化要赋值的数组
////                int [][]arr = new int[size*size][3];
////                int k=0;
////                for(int i = 0;i<arr.length;i++) {
...
//                return modelAndView;
//            }else{//分块图
//                double [][]arr2 = predictService.listconverttoarr_p(list2);
//                //初始化要赋值的数组
////                int [][]arr = new int[size*size][3];
////                int k=0;
////                for(int i = 0;i<arr.length;i++) {
...
//    @ResponseBody
//    public Object getonezhusea(@RequestParam("column") int  column ,@RequestParam("row")int  row,int ){
//        List<fungus> list1 ;
//        List<predict> list2 ;
//
//        if(listzhu2 == null){
//            list1 = fungusService.findinthisfungi(listzhu,column,row);
//            return list1;
//        }else if(listzhu == null){
//            list2 = predictService.findinthisfungi_p(listzhu2,column,row);
//            return list2;
//        }else{
//
//            return findinthisfungi_fp(listzhu,listzhu2,column,row);
//
//        }
//    }
//    //散点图searchajax接口
...
//    @ResponseBody
//    public Object getphotos(@RequestParam("img") String img ,@RequestParam("name")String  name){
//        String src = img;
//        JSONObject jsonObject = new JSONObject();
//        String str1 = "{\"alt\":\""+name+"\",\"pid\":12,\"src\":\""+src+"\",\"thumb\":\""+src+"\"}";
//        String str="{\"title\":\""+name+"\",\"id\":1,\"start\":0,\"data\":["+str1+"]}";
//       return str;
//    }
//
//}
